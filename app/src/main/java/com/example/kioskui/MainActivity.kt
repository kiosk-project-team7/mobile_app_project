    ...
    class menuInit {
        companion object {
            ...
            val desc = arrayListOf<String>( //12
                ...
                "기네스블랙번과 특제 기네스BBQ소스 그리고 불에 직접 구운 100% 순쇠고기 패티 그리고 네가지 고품격 치즈로 탄생한 기네스콰트로치즈와퍼",
                ...
                "믿고 먹을 수 있는 와퍼, 불에 직접 구운 100% 순쇠고기 패티 2장으로 더 크게 도전하세요! 스태커2와퍼",
                "믿고 먹을 수 있는 와퍼, 불에 직접 구운 100% 순쇠고기 패티 3장으로 더 크게 도전하세요! 스태커3와퍼")
